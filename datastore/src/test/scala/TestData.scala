...
object TestData {
  ...
  private[datastore] val TestIcalWithEventFileName = "testIcalFile.ics"
  private[datastore] val TestIcalFileWithEvent = TestDataRoot + "/" + TestIcalWithEventFileName
  ...
  private[datastore] val PlainTextContentType = "text/plain"
  ...
  private[datastore] val PlainTextDataMap = ComplexObject(GenericMediaFileType, Map(
