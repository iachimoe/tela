...
class EventsController @Inject()(@Named("session-manager") sessionManager: ActorRef)(implicit actorSystem: ActorSystem, val materializer: Materializer, val ec: ExecutionContext) {
